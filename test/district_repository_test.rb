...
class DistrictRepositoryTest < Minitest::Test
  ...
  def test_load_data_method_chooses_correct_key
    dr = DistrictRepository.new
    data = dr.load_data({:enrollment => {:kindergarten => "./test/fixtures/Kindergartners in full-day program fixture.csv"}})

    assert_equal [:enrollment], data.keys
  end
